...
const s = StyleSheet.create({
  ...
  createBtn: {
    backgroundColor: '#A582F7', borderRadius: 8, paddingVertical: 10, alignItems: 'center', marginBottom: 16,
  },
  ...
  submitBtn: { backgroundColor: '#A582F7', borderRadius: 6, paddingHorizontal: 16, paddingVertical: 8 },
  ...
  optionVoted: { borderWidth: 1, borderColor: '#A582F7' },
  optionBar: {
